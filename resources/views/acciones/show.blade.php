            ...
            <div class="col-md-12">
                <div class="card mx-auto" style="width: 50%;">
                    <div class="card-header bg-dark text-light">
                        <h5 class="mb-0">{{--  --}}
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="20" fill="currentColor" class="bi bi-fingerprint" viewBox="0 0 16 16">
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            <tbody>
                                ...
                                {{-- <tr>
                                    <th>Responzable</th>
                                    <td>{{ $accion->auditoria->empleado->nombre_empleado }}</td>
                                </tr> --}}
                                {{-- <tr>
                                    <th>Empleados</th>
                                    <td>
                                        @foreach ($accion->empleados as $empleado)
